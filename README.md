...
-   Challenge에 대한 이미지 첨부 시, 최초 사진과의 유사성 검사 및 재촬영 안내를 통해 완성 Mp4 파일의 품질 향상
-   Challenge 종료 후 피드 등록 시, 첨부된 사진들을 연속시켜 Mp4 파일로 변환
...
| 예시 | 설명 |
| :-----: | :-----: |
| <img src="./image/main.gif"  height="200" /> | 로그인 유저별 점수화된 추천 피드 순으로 제공, 챌린지 생성 및 진행 가능 |

### Profile 보기, 상세 정보 보기

| 예시 | 설명 |
| :-----: | :-----: |
| <img src="./image/profile_detail.gif"  height="200" /> | 다른 사람의 아이콘을 눌러 프로필에 방문할 수 있고, 피드를 선택해 상세보기를 진행 가능 |

### 해시태그 기반 검색 및 초성 검색

| 예시 | 설명 |
| :-----: | :-----: |
| <img src="./image/search.gif"  height="200" /> | 해시태그 자동 완성, 해시태그 기반 검색, 해시태그 초성 검색 가능 |

### 피드의 영향력 보기(뿌리보기)

| 예시 | 설명 |
| :-----: | :-----: |
| <img src="./image/tree.jpg"  height="200" /> | 특정 피드의 선한 영향력 정도를 UI를 통해 직관적으로 보기 가능 |
